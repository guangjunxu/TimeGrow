...
public class DBUtil {
	...
	public static void loadAlbum(Activity father, ArrayList<Album> allalbum)// 从日程数据库读取日程数据
	{
		try {
			sld = SQLiteDatabase.openDatabase(
					"/data/data/com.guangjun.timegrow/myDb", null,
	...
	public static void insertPicture(MainActivity father, int curalbumid)// 插入日程
	{
		try {
			sld = SQLiteDatabase.openDatabase(
					"/data/data/com.guangjun.timegrow/myDb", null,
	...
	public static void loadPicture(Activity father, int curalbumid)// 从日程数据库读取日程数据
	{
		try {
			sld = SQLiteDatabase.openDatabase(
					"/data/data/com.guangjun.timegrow/myDb", null,
	...
	public static void insertPicture(Activity father, Picture tmppicture)// 插入日程
	{
		try {
			sld = SQLiteDatabase.openDatabase(
					"/data/data/com.guangjun.timegrow/myDb", null,
